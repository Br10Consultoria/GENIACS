      ...
      if (window.authorizer.hasAccess("provisions", 1)) {
        tabs.push(
          m(
            ...
            m("a", { href: "#!/admin/provisions" }, "Provisionamento"),
          ),
        );
      }
      ...
      if (window.authorizer.hasAccess("config", 1)) {
        tabs.push(
          m(
            "li",
            { class: active["config"] },
            m("a", { href: "#!/admin/config" }, "Configurações"),
          ),
        );
      }
      ...
      if (window.authorizer.hasAccess("permissions", 1)) {
        tabs.push(
          m(
            ...
            m("a", { href: "#!/admin/permissions" }, "Permissões"),
          ),
        );
      }
      ...
      if (window.authorizer.hasAccess("users", 1)) {
        tabs.push(
          m(
            "li",
            { class: active["users"] },
            m("a", { href: "#!/admin/users" }, "Usuários"),
          ),
        );
      }

      return m("nav#side-menu", { "aria-label": "Administração" }, m("ul", tabs));
    },
  };
};
